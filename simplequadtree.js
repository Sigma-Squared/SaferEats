...
class SimpleQuadTree {
    constructor(min_x, min_y, max_x, max_y,  thisdepth, max_depth) {
        ...
        if (thisdepth != max_depth) {
            ...
            this.tl = new SimpleQuadTree(min_x, min_y, mid_x, mid_y, thisdepth+1);
            this.tr = new SimpleQuadTree(mid_x, min_y, max_x, mid_y, thisdepth+1);
            this.bl = new SimpleQuadTree(min_x, mid_y, mid_x, max_y, thisdepth+1);
            this.br = new SimpleQuadTree(mid_x, mid_y, max_x, max_y, thisdepth+1);
        }
        else {
            this.leaf = true;
